import { renderSummary } from "../../scripts/checkout/order.js";
...
describe('test suite: renderSummary', () => {
    ...
    it('removes item from cart', () => {
        ...
        expect(
            document.querySelector(`.js-cart-container-${productId1}`)).toEqual(null);
        expect(
            document.querySelector(`.js-cart-container-${productId2}`)).not.toEqual(null);
